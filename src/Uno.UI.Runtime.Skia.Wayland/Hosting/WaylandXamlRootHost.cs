...
#pragma warning restore CS0414
	...
	{
		// Init clipboard on event thread — must happen here because selection
		// events require keyboard focus (which our main window has)
		...
		{
			// Process pending clipboard copy requests
