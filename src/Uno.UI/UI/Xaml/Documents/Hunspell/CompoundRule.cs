...
public readonly struct CompoundRule : IReadOnlyList<FlagValue>
{
	...
	public bool Equals(CompoundRule other) => (RawArray as IStructuralEquatable).Equals(other.RawArray, StructuralComparisons.StructuralEqualityComparer);

	public override bool Equals(object? obj) => obj is CompoundRule other && Equals(other);

	public override int GetHashCode() => (RawArray as IStructuralEquatable).GetHashCode(StructuralComparisons.StructuralEqualityComparer);

	public static bool operator ==(CompoundRule left, CompoundRule right) => left.Equals(right);

	public static bool operator !=(CompoundRule left, CompoundRule right) => !left.Equals(right);

	internal FlagValue[] RawArray => _values ?? [];
