...
public readonly struct SingleReplacementSet : IReadOnlyList<SingleReplacement>
{
	...
	public bool Equals(SingleReplacementSet other) => (RawArray as IStructuralEquatable).Equals(other.RawArray, StructuralComparisons.StructuralEqualityComparer);

	public override bool Equals(object? obj) => obj is SingleReplacementSet other && Equals(other);
	...
	public static bool operator ==(SingleReplacementSet left, SingleReplacementSet right) => left.Equals(right);
