...
public readonly struct MapTable : IReadOnlyList<MapEntry>
{
	...
	public bool Equals(MapTable other) => RawArray.SequenceEqual(other.RawArray);

	public override bool Equals(object? obj) => obj is MapTable other && Equals(other);

	public override int GetHashCode() => ((IStructuralEquatable)RawArray).GetHashCode(EqualityComparer<MapEntry>.Default);

	public static bool operator ==(MapTable left, MapTable right) => left.Equals(right);
