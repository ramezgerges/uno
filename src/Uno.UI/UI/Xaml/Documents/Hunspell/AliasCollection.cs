...
public readonly struct AliasCollection<TEntry> : IReadOnlyList<TEntry>
{
	...
	public bool Equals(AliasCollection<TEntry> other) => RawArray.SequenceEqual(other.RawArray);

	public override bool Equals(object? obj) => obj is AliasCollection<TEntry> other && Equals(other);

	public override int GetHashCode() => ((IStructuralEquatable)RawArray).GetHashCode(EqualityComparer<TEntry>.Default);

	public static bool operator ==(AliasCollection<TEntry> left, AliasCollection<TEntry> right) => left.Equals(right);
