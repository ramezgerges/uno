...
public readonly struct PhoneTable : IReadOnlyList<PhoneticEntry>
{
	...
	public bool Equals(PhoneTable other) => (RawArray as IStructuralEquatable).Equals(other.RawArray, StructuralComparisons.StructuralEqualityComparer);

	public override bool Equals(object? obj) => obj is PhoneTable other && Equals(other);
	...
	public static bool operator ==(PhoneTable left, PhoneTable right) => left.Equals(right);

	public static bool operator !=(PhoneTable left, PhoneTable right) => !left.Equals(right);

	internal PhoneticEntry[] RawArray => _items ?? [];
}
