...
#pragma warning restore IDE0060 // Remove unused parameter
	...
	public bool Equals(PatternSet other) => (RawArray as IStructuralEquatable).Equals(other.RawArray, StructuralComparisons.StructuralEqualityComparer);

	public override bool Equals(object? obj) => obj is PatternSet other && Equals(other);
	...
	public static bool operator ==(PatternSet left, PatternSet right) => left.Equals(right);

	public static bool operator !=(PatternSet left, PatternSet right) => !left.Equals(right);

	internal PatternEntry[] RawArray => _patterns ?? [];
}
