	...
	protected override void OnRightTapped(RightTappedRoutedEventArgs e)
	{
		...
		if (IsSkiaTextBox)
		{
			if (_contextMenu is null)
			{
				...
				_flyoutItems.Add(ContextMenuItem.Undo, new MenuFlyoutItem { Text = ResourceAccessor.GetLocalizedStringResource("TextBoxUndo"), Command = new TextBoxCommand(Undo), Icon = new SymbolIcon(Symbol.Undo) });
				_flyoutItems.Add(ContextMenuItem.Redo, new MenuFlyoutItem { Text = ResourceAccessor.GetLocalizedStringResource("TextBoxRedo"), Command = new TextBoxCommand(Redo), Icon = new SymbolIcon(Symbol.Redo) });
